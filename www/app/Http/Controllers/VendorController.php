...
class VendorController extends Controller
{
    ...
    {
        $dataBag = [];
        $dataBag['sidebar_parent'] = 'vendor_management';
        $dataBag['sidebar_child'] = 'all-vendors';
        $authId = Auth::user()->id;
        ...
        if ($request->ajax()) {
            return view('backend.vendor.all-vendors-render', $dataBag);
        }

        return view('backend.vendor.index', $dataBag);
    }
    ...
    public function add(Request $request)
    {
        $dataBag = [];
        $dataBag['sidebar_parent'] = 'vendor_management';
        $dataBag['sidebar_child'] = 'add-vendor';

        return view('backend.vendor.add', $dataBag);
    }
    ...
    public function save(Request $request)
    {
        ...
        if ($user->save()) {
            ...
            return redirect()->back()
                ...
                ->with('message_text', 'New vendor has been created successfully');
        }
        return back()
            ->with('message_type', 'error')
    ...
    public function delete(Request $request, $id)
    {
        ...
        return redirect()->back()
            ->with('message_type', 'success')
            ->with('message_title', 'Done!')
            ->with('message_text', 'Vendor has been deleted successfully');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('backend.vendor.edit', $dataBag);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($user->save()) {
            ...
            return redirect()->back()
                ->with('message_type', 'success')
                ->with('message_title', 'Done!')
                ->with('message_text', 'Vendor has been updated successfully');
        }
        return back()
            ->with('message_type', 'error')
            ->with('message_title', 'Server Error!')
    ...
    public static function saveOtherInformation($request, $userId)
    {
        ...
        $obj->gst_no = $request->input('gst_no') ?? null;
        $obj->vat_no = $request->input('vat_no') ?? null;
