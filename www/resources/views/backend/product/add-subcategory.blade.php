...
@section('content_title', 'Add New Product Sub-Category')
...
<form name="frm" id="frmx" action="{{ route('product.subcategory.saveSubCategory') }}" method="POST">
@csrf
<div class="row">
    <div class="col-md-5">
...
<div class="row">
    <div class="col-md-5">
        <div class="form-group">
            ...
            <input type="text" name="name" id="subCategoryName" class="form-control" placeholder="Enter Category Name" required="required"/>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
...
<div class="row">
    <div class="col-md-8">
        <div class="form-group">
            ...
            <textarea name="description" id="subCategoryDescription" class="form-control" placeholder="Enter Sub-Category Description..."/></textarea>
        </div>
    </div>
    <div class="col-md-4"></div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <button type="button" class="btn btn-success" id="frmActionBtn"><i class="fas fa-plus"></i> Add Sub-Category</button>
    </div>
